package munchkingeorge.evil_science.robot;

import munchkingeorge.evil_science.Evil_Science;
import munchkingeorge.evil_science.items.RangedFighterRobotSpawner;
...
public class EntityRangedFighterRobot extends EntityTameable implements IRangedAttackMob
{
	...
	private boolean flameArrow = false;
    ...
    public EntityRangedFighterRobot(World par1World)
    {
        super(par1World);
    ...
    {
    	this.dropItem(Evil_Science.RangedFighterRobotSpawner.itemID, 1);
    ...
    public void onLivingUpdate()
    {
        ...
        if (!this.isTamed())
        {
            this.Tame(RangedFighterRobotSpawner.OwnerPlayer);
        }
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        if (itemstack != null)
        {
            ...
            if (itemstack != null && itemstack.itemID == Evil_Science.FlameArrowUpgrader.itemID)
            {
            	if(!(this.flameArrow == true))
            	{
            		if (!par1EntityPlayer.capabilities.isCreativeMode)
                    {
                        --itemstack.stackSize;
            ...
            if (itemstack != null && itemstack.itemID == Evil_Science.Reader.itemID)
            {
            	...
            	Player.addChatMessage("Flame Arrows =" + this.flameArrow);
            	return true;
            	}
            }
        }
    ...
    public void Tame(EntityPlayer par1EntityPlayer)
    {
        if (!this.worldObj.isRemote)
        {
	...
	public void attackEntityWithRangedAttack(EntityLivingBase par1EntityLivingBase,
        ...
        entityarrow.setDamage(1D * this.attackDamage);
